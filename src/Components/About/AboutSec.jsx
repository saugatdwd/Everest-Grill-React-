  ...
  return (
    ...
    <>
      <div className="bg-gray-200 h-[100vh] pt-14 md:pt-0 md:pb-0 pb-14">
        <div
          className="md:min-h-screen  max-w-[90vw] mx-auto flex flex-col-reverse md:flex-row items-center gap-y-5
     "
        >
          ...
          <div className="w-full md:w-2/4 text-center space-y-6">
            ...
            <p>
              Nestled amidst the bustling streets of Kathmandu, Nepal, our
              restaurant offers a culinary journey steeped in tradition and
              innovation. With a cozy ambiance adorned with local artwork and
              accents, guests are transported to a realm of warmth and
              hospitality.
            </p>
